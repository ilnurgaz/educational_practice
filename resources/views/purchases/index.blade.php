        ...
        <form method="GET" action="{{ route('purchases.index') }}" class="mb-5">
            <div class="flex flex-wrap gap-4">
                ...
                <div class="flex justify-end w-full sm:w-1/4">
                    <a href="{{ route('purchases.selectSupplier') }}"
                        class="bg-blue-600 hover:bg-blue-700 w-full text-white px-4 py-2 rounded text-center transition duration-300">
                        Добавить закупку
                    </a>
                </div>
            </div>
            ...
            <table class="w-full table-auto">
                ...
                <tbody>
                    ...
                    <tr class="border-t">
                        ...
                        <td class="px-4 py-2">
                            {{ $purchase->total_amount ? number_format($purchase->total_amount, 2) . ' ₽' : 'Не указано' }}
                        </td>
                        <td class="px-4 py-2">
